  ...
  return (
    <main className="h-screen w-screen">
      ...
      <div className="flex h-full  w-full flex-col items-center gap-5">
        ...
        <form className="" >
          <input className="rounded-lg rounded-r-none" type="text" name="word" id="word" />
          <button className="bg-purple-500 px-3 py-1 rounded-lg rounded-l-none" type="submit">Send</button>
        </form>
      </div>
    </main>
  );
