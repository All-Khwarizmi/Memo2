        ...
        <Modal size={"3xl"} isOpen={true} onClose={onClose}>
          ...
          <ModalContent>
            ...
            <ModalBody className="min-h-300">
              <div className="h-[100%] flex-col place-items-center gap-5 text-black">
                <div className="lex min-h-500px w-[100%]  ">
                  <table className=" min-h-500px relative w-[100%] w-full text-left text-sm text-gray-500 dark:text-gray-400">
