...
const DicoModal = () => {
  ...
  const fetchDico = async (word: string): Promise<void> => {
    ...
    return (
      <>
        <button className="className="rounded-lg bg-gray-400 px-3 py-2 font-bold text-black dark:bg-gray-900 dark:text-white"" onClick={onOpen}>FR - ESP</button className="className="rounded-lg bg-gray-400 px-3 py-2 font-bold text-black dark:bg-gray-900 dark:text-white"">
