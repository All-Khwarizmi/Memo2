    ...
    return (
      <>
        ...
        <Modal size={"xl"} isOpen={true} onClose={onClose}>
          <ModalOverlay />
          <ModalContent className="bg-gray-700 text-center text-white ">
            <ModalHeader className="font-bold text-2xl">Français - Espagnol</ModalHeader>
            <ModalCloseButton />
            <ModalBody className="min-h-300 ">
                ...
                <div className=" ">
                  <table className="   w-full text-left text-sm text-gray-500 dark:text-gray-400">
                    <thead
                      ...
                      }  top-0 bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-400 dark:text-gray-400`}
                    >
                      <tr className="w-[100%] ">
              ...
              <div className="grid  place-items-center">
                ...
                >
                  ...
                  />
                  <button
                    className="bg-gray-700px-3 rounded-lg rounded-l-none bg-gray-700 px-2 py-1.5 font-bold text-white"
                    type="submit"
                  >
                    Chercher
                  </button>
              ...
              <div className="grid place-items-center">
                <button
                  className="rounded-lg bg-gray-700 px-3 py-2 font-bold text-white"
                  onClick={onClose}
                >
                  Close
                </button>
