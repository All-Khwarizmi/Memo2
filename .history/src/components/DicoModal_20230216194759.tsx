    ...
    return (
      <>
        ...
        <Modal size={"xl"} isOpen={true} onClose={onClose}>
          <ModalOverlay />
          <ModalContent className="dark:bg-gray-700 text-center dark:text-white ">
            ...
            <ModalBody className="min-h-300 ">
              <div className=" grid-row grid items-center gap-5 text-black">
                <div className=" ">
                  <table className=" bg-gray-400  w-full text-left text-sm text-gray-500 dark:text-gray-400">
                    <thead
                      className={`sticky ${
                        translations.length ? null : "hidden"
                      }  top-0 bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-900 dark:text-gray-400`}
                    >
                      <tr className="w-[100%] ">
              ...
              <div className="grid  place-items-center">
                ...
                >
                  ...
                  />
                  <button
                    className="bg-gray-700px-3 rounded-lg rounded-l-none px-2 py-1.5 font-bold text-white dark:bg-gray-900"
                    type="submit"
                  >
                    Chercher
                  </button>
              ...
              <div className="grid place-items-center">
                <button
                  className="rounded-lg px-3  py-2 font-bold text-white dark:bg-gray-900"
                  onClick={onClose}
                >
                  Close
                </button>
