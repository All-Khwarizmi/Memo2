  ...
  const fetchDico = async (word: string): Promise<void> => {
    ...
    return (
      <>
        ...
        <Modal className="" size={"xl"} isOpen={true} onClose={onClose}>
          <ModalOverlay />
          <ModalContent>
            ...
            <ModalBody className="min-h-300">
              ...
              <div className="grid  place-items-center">
                ...
                >
                  ...
                  />
                  <button
                    className="bg-gray-700px-3 rounded-lg rounded-l-none bg-gray-700 px-2 font-bold text-white py-1.5"
                    type="submit"
                  >
                    Chercher
                  </button>
              ...
              <div className="grid place-items-center">
                <button
                  className="font-bold rounded-lg bg-gray-700 px-3 py-2 text-white"
                  onClick={onClose}
                >
                  Close
                </button>
