          ...
          <ModalBody className="min-h-300  ">
            ...
            <div className="grid  place-items-center">
              <form className="py-5 text-black" onSubmit={(e) => submitWord(e)}>
                ...
                />
                <button
                  className="bg-gray-700 px-3 dark:text-whitedark:bg-gray-900 rounded-lg rounded-l-none bg-gray-400 px-3  py-1.5 font-bold font-bold dark:bg-gray-900 dark:text-white"
                  type="submit"
                >
                  Chercher
                </button>
